...
const BottomNav = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-[#262626] p-2 h-16 flex justify-around">
      <button
        onClick={() => navigate("/")}
        className="flex items-center justify-center font-bold text-[#f5f5f5] bg-[#343434] text-[#ababab] w-[300px] rounded-[20px]"
      >
      ...
      <Modal isOpen={isModalOpen} onClose={closeModal} title="Nuevo Pedido">
        <div>
          ...
          <div className="flex items-center rounded-lg p-3 px-4 bg-[#1f1f1f]">
            ...
            id="" className="bg-transparent flex-1 text-white focus:outline-none"  
            />
          </div>
        </div>
        <div>
